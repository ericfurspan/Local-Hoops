    ...
    if (this.props.currentUser) {
      ...
      return (
        <View style={[styles.centeredContainer, { backgroundColor: '#eee' }]}>
          {this.state.showAddFriendModal || this.state.showViewFriendModal ? <StatusBar hidden /> : null}
          <Header
          ...
          <Modal transparent={false} visible={this.state.showAddFriendModal}>
          ...
          {/* VIEW FRIEND */}
          <Modal transparent={false} visible={this.state.showViewFriendModal}>
            <View style={styles.modalBackground}>
              <View style={[styles.modalContent]}>
                ...
                <ViewFriend
                  ...
                  friend={
                    this.state.selectedFriend
                      ? this.props.friends.find((f) => f.uid === this.state.selectedFriend)
                      : null
                  }
