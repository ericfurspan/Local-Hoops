...
class Login extends React.Component {
  ...
  render() {
    if (this.state.showResetForm) {
      return <ForgotPassword login_form={this.props.login_form} toggleResetForm={this.toggleResetForm} />;
    ...
    return (
      <View style={{ paddingTop: 30, backgroundColor: '#3578E5', flex: 1 }}>
        ...
        <View
          style={{ justifyContent: 'flex-start', alignItems: 'center', marginTop: 45 }}
          testID="loginForm"
        >
          {
            // SIGN IN
          ...
          <Input
            ...
            leftIcon={{ name: 'lock', type: 'font-awesome', color: '#333', size: 24 }}
          ...
          <View style={{ marginTop: 55, alignItems: 'center' }}>
            ...
            <View style={styles.row}>
              <SocialIcon type="facebook" raised onPress={() => this.triggerFacebookSignIn()} />
              <SocialIcon type="google-plus-official" raised onPress={() => this.triggerGoogleSignIn()} />
            </View>
          </View>
        </View>
      </View>
