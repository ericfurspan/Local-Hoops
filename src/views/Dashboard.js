...
import EventForm from '../components/Event/CreateEvent/EventForm';
    ...
    if (this.props.currentUser) {
      ...
      return (
        <View style={[styles.container, { backgroundColor: '#FAFAFA' }]} testID="Dashboard">
          ...
          {this.state.showEventFormModal ? <StatusBar hidden /> : null}
          <Header
            centerComponent={
              <Image
                source={Logo}
          ...
          <View style={[styles.centeredContainer, { paddingBottom: 20 }]}>
            <ScrollView>
                        ...
                        <TouchableOpacity
                          ...
                          onPress={() => {
                            ...
                            this.props.navigation.navigate('Explore', {
                              action: { type: 'showCourt', data: court },
                            });
                          }}
                        >
                          {/* <Mapbox.MapView
              ...
              <Divider
                style={{ marginBottom: 30, marginTop: 30, width: deviceWidth * 0.9, alignSelf: 'center' }}
              />
              ...
              <View style={{ height: deviceHeight * 0.6, alignItems: 'center' }} testID="RecentActivity">
                <View style={{ width: deviceWidth, flexDirection: 'row', justifyContent: 'space-between' }}>
                  ...
                  <Button
                    ...
                    icon={{ name: 'plus', type: 'font-awesome', size: 25, color: '#3578E5' }}
                    title="New Event"
                ...
                <Modal transparent={false} visible={this.state.showEventFormModal}>
                  <View style={styles.modalBackground}>
                    <View style={styles.modalContent}>
                      <EventForm
                        onClose={() => this.setEventFormModalVisible(false)}
                ...
                <Modal animationType="slide" transparent={false} visible={this.state.showAccountModal}>
                  <View style={styles.modalBackground}>
                    <View style={styles.modalContent}>
                      <Account />
                    </View>
      ...
      return <Loading message="" indicator={false} />;
    }
  }
}
