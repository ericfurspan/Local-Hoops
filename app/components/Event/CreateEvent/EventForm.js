        ...
        return (
          <View style={styles.centeredContainer}>
            ...
            <Picker
              ...
              onValueChange={value =>
                this.props.dispatch(updateTempEventType(value))
              }>
        ...
        return (
          <View style={styles.centeredContainer}>
            ...
            <DatePickerIOS
              mode="date"
              date={
                this.props.tempEvent && this.props.tempEvent.date
                  ? this.props.tempEvent.date
                  : new Date()
              }
              style={{width: deviceWidth * 0.75, height: deviceHeight * 0.4}}
              onDateChange={date =>
                this.props.dispatch(updateTempEvent(date, 'date'))
              }
            />
          </View>
        );
          ...
          <View style={styles.centeredContainer}>
            <Header
              ...
              rightComponent={
                <Icon
                  ...
                  type="ionicon"
                  color={
                    this.props.tempEvent && !this.props.tempEvent.court
                      ? '#444'
                      : '#FFFFFF'
                  }
                  size={40}
            ...
            <SelectCourt
              ...
              onSelect={(court, selType) => {
                this.props.dispatch(
                  updateTempEvent({...court, selType}, 'court')
                );
              }}
        ...
        return (
          <View style={styles.centeredContainer}>
            ...
            <Input
              ...
              onChangeText={val =>
                this.props.dispatch(updateTempEvent(val, 'comment'))
              }
              containerStyle={{
